...
public final class paginaInicial_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<h3 class=\"muted\" align=\"center\">Perfil RH</h3>&nbsp;\n");
      ...
      out.write("\t\t\t\t<font color=\"#8B0000\">Alertas Urgentes</font>\n");
      out.write("\t\t\t</h1>\n");
      out.write("\t\t\t&nbsp;\n");
      ...
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<th>ID</th>\n");
      out.write("\t\t\t\t\t\t<th>Tarefa</th>\n");
      out.write("\t\t\t\t\t\t<th>Funcionário</th>\n");
      out.write("\t\t\t\t</thead>\n");
      out.write("\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t\t<tr class=\"warning\">\n");
      out.write("\t\t\t\t\t\t<td>01</td>\n");
      out.write("\t\t\t\t\t\t<td>Tarefa 1</td>\n");
      out.write("\t\t\t\t\t\t<td>Lara</td>\n");
      out.write("\t\t\t\t\t\t<td><button class=\"btn btn-small btn-danger\">Fazer</button></td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\n");
      out.write("\t\t\t\t</tbody>\n");
      out.write("\t\t\t</table>\n");
