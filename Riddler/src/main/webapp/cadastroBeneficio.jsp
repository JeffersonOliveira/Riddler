		...
		<div class="form">
			<form action="cadastrarBeneficios" method="post">
				<div>
					...
					Prazo <input type="text" class="prazo" id="datepicker"  name="beneficio.prazo" />
				</div>
				<div class="control-group  " id="rendered">

					<div class="clone count">
						<label class="control-label" for="inputEtapa">Etapa 1:</label>
							<input class="etapaName" type="text" id="inputEtapa" name="beneficio.etapas[0].nome" placeholder="Nome da etapa">
							<input type="hidden" id="ordem" class="ordem" name="beneficio.etapas[0].ordem" value="1" />
				...
				<i class="icon-plus-sign" id="add"></i> <input type="submit"
	...
	<script type="text/javascript">
		$(function() {
			$("#add").click(function() {
				...
				var name = "beneficio.etapas[" + (etapaCount -1) + "].nome";
				var order = "beneficio.etapas[" + (etapaCount -1) + "].ordem";
				$(clone).find('label').text('Etapa ' + etapaCount + ':');
